 ...
 */
public class RedisScheduler extends DuplicateRemoverScheduler implements DuplicateRemover<Request> {
    private JedisPool pool;
    private static final Logger LOGGER = Logger.getLogger(RedisScheduler.class);
