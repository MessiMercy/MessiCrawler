 ...
 */
public class SinaNewsProcesser extends RedisScheduler implements Processer {
    private static Reader reader;
    private static SqlSessionFactory factory;
    private static ExecutorService service = Executors.newFixedThreadPool(10);
    private static Downloader dw = new Downloader(HttpConstant.UserAgent.CHROME, false);
    private static MongoClient mongoClient = new MongoClient("127.0.0.1");
    private static JedisPool pool = new JedisPool("127.0.0.1");
    private static MongoDatabase test = mongoClient.getDatabase("test");
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        processer.searchButton("消费金融");
    }

    private void func(MongoDatabase database, CountDownLatch latch) {
//        String[] keywords = new String[]{"走出去", "跨境", "跨境投资", "跨境并购", "海外并购", "海外投资", "境外投资", "全球化", "全球投资", "引进来", "外商投资", "外资", "招商引资", "跨境招商", "利用外资"};
//        searchNews(pool, "外资");
//        for (int i = 1; i < keywords.length; i++) {
//            int finalI = i;
//            service.submit(() -> searchNews(pool, keywords[finalI]));
//        }
//        try (Jedis jedis = pool.getResource()) {
//            String temp = "";
//            while ((temp = jedis.spop("newsGroup")) != null) {

//            }
//            latch.countDown();
//        }addRetryTimesaddRetryTimesaddRetryTimes
    }
